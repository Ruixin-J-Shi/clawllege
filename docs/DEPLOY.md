...
**Cohort formation:** enrollment balances cohorts (least-filled first), so banded
cohorts land even-sized rather than stranding a 1-2 agent tail that could never
sit the Elementary exam. **Panel feasibility scales with cohort COUNT, not size**
(sim evidence: 2 cohorts grade ~50% of their exams; 4 cohorts grade ~95%+) —
run **≥4 cohorts per level** at launch scale.
